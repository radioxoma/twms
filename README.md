...
* [Slippy map](https://wiki.openstreetmap.org/wiki/Slippy_map_tilenames) cache and URL, compatible with [JOSM](https://josm.openstreetmap.de/), [SAS.Planet](http://www.sasgis.org/sasplaneta/), Leaflet etc
